        ...
        <Card>
          <CardContent className="py-3">
            ...
            <ul className="text-xs text-muted-foreground space-y-1">
              ...
              <li>• Report date and MediLog branding</li>
            </ul>
          </CardContent>
        </Card>
      </div>
...
function buildDetailedPDF(m: MemberData, records: RecordData[], meds: MedicineData[], rems: ReminderData[]): string {
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>MediLog Report — ${m.name}</title><style>${CSS}</style></head><body>
<div class="header"><h1>MediLog Health Report</h1><p>Comprehensive health summary</p><p style="font-size:9px;">This report is for informational purposes only</p></div>
${memberSection(m, records, meds, rems)}
<div class="footer"><p>Generated by MediLog — India's Family Health Record Manager | medi--log.vercel.app</p></div>
</body></html>`;
}
...
function buildFullFamilyPDF(
  ...
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>MediLog Family Report</title><style>${CSS}</style></head><body>
<div class="header"><h1>MediLog Family Health Report</h1><p>${allMembers.length} family members</p><p style="font-size:9px;">This report is for informational purposes only</p></div>
${sections}
<div class="footer"><p>Generated by MediLog — India's Family Health Record Manager | medi--log.vercel.app</p></div>
</body></html>`;
}
