...
function buildReportHTML(
  ...
  return `<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>MediFamily Health Report - ${member.name}</title>
<style>
...
<div class="header">
  <h1>MediFamily Health Report</h1>
...
<div class="footer">
  <p>Generated by MediFamily — India's Family Health Record Manager</p>
